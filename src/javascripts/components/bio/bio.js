...
const bioString = () => {
  let domString = '';
  domString += '<h2 id"about">About Me</h2>';
  ...
  domString += '<p> After several years in the workforce, I would begin a new journey in life. I decided to pursue an important life goal of becoming the first male in my family to graduate from college. I earned a BBA and MBA both with an concentration in Finance from MTSU while working full-time in banking.';
