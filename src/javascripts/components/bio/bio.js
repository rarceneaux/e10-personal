...
const bioString = () => {
  ...
  domString += '<p> I plan to use the skill set of software development professionally for the benefit of the community and my family.</p>';
  domString += '<p> Please listen to my podcast interview as I share my journey at NSS and the relationships I gained during the process and my future plans in tech.</p>';
  domString += '<br>';
