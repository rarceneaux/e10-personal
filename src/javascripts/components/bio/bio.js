...
const bioString = () => {
  ...
  domString += '<p> My website displays my Front-End Capstone Title: My-Dash, QB₁ individual project, and two group projects. The projects are all front-end applications I completed during the first six months at NSS.</p>';
