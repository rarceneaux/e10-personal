...
const bioString = () => {
  let domString = '<h2>About Me</h2>';
  domString += '<p> As a native of Nashville, I started my professional career by obtaining my real estate license. I specialized in helping For Sale By Owners (FSBOs) sell their homes at a reduced commission. I sold homes for several years before I was presented with the opportunity to list a commercial property. The experience I gained in the commercial sector directed me to an interest in finance. I would eventually find a job as a retail banker and retire my license. I also decided to pursue the dream of becoming the first male in my family to graduate from college. I have valued continuous personal and educational growth throughout my life. After receiving a BBA and MBA in Finance from MTSU, I continued my career in the financial services industry with UBS.</p>';
