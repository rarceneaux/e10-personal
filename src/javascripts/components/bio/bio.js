...
const bioString = () => {
  ...
  domString += '<p>I currently work for the State of Tennessee in the Department of General Services as an Real Property Agent. My area of expertise is to support the various state agencies in their real estate transactions. I have over 20 years of business experience in retail banking, financial markets, and real estate.    </p>';
  domString += '<p> My why for becoming a software developer is to teach and expose at-risk male youth to coding in addition to having the ability to provide my family a comfortable lifestyle.</p>';
